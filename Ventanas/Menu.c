    ...
    while(true) {
        ...
        case 4:     //Árboles
            if (WmenuArbol == NULL) {
                ...
                MenuTitulo="Busqueda";
                MenuOpciones[0]="Busqueda secuencial por autor";
                MenuOpciones[1]="Busqueda binaria por autor";
                MenuOpciones[2]="Busqueda en arbol binario por autor";
