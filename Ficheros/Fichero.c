...
void Fichero(DISCO **Fichas,int OpcionMenu)
{
    ...
    switch (OpcionMenu) {
        case 21:    // Importar un fichero a una lista nueva
            ...
            break;
        case 22:    // Sumar los discos de un fichero a una lista existente
            ImportarFichero(Fichas,Wfichero,true);
            break;
        case 23:    // Exportar la lista de discos a un fichero
            ExportarFichero(Fichas,Wfichero);
            break;
        case 24:    // Eliminar la lista de discos existente  
